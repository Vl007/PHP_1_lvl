...
if ($operac){
    if (is_numeric($a) && is_numeric($b)){
        ...
        $result = '<h3>Ничего не введено</h3>';
    }
}
?>
...
<head>
    ...
    <style>
        button{font-size: 29px; vertical-align: middle} input{padding: 10px;font-size: 15px}
    </style>
...
<form method="get">
    <label>
        <input type="text" placeholder="Введите первое число" name="a">
    </label>
    ...
    <input type="text" placeholder="Введите второе число" name="b">
